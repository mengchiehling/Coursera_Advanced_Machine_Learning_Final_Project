...
if __name__ == "__main__":
    ...
    # 01
    # -35.32200752839899
    # {'colsample_bytree': 0.7, 'gamma': 1, 'learning_rate': 0.025, 'max_depth': 7, #'min_child_weight': 1, 'n_estimators': 400, 'subsample': 0.8}

    # 02    
#-33.13931155510171
    #{'colsample_bytree': 0.9, 'gamma': 1, 'learning_rate': 0.025, 'max_depth': 3,    #'min_child_weight': #1, 'n_estimators': 400, 'subsample': 0.8}
